...
// Some of the vector functions are static inline in q_shared.h for native
// builds. For the QVM build, q_shared.h declares them extern and this file
// defines them out of line. Stock relied on __Q3_VM_MATH here plus the
// original q3asm treating every symbol as global, so the static copies this
// file pulled from the header satisfied other files' externs by accident; a
// q3asm that scopes statics per file (like this tree's) needs real
// definitions.
